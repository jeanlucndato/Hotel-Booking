...
def category(request,foo):
    ...
    try:
        ...
        messages.success(request, ("that category does'nt existe yet ....."))
...
def login_user(request):
    if request.method == "POST":
        ...
        if user is not None:
            login(request, user)
            messages.success(request, ("Tu est connecter"))
            return redirect('home')
        else:
            messages.success(request, ("il y a un erreur, veuillez tante plus tard"))
